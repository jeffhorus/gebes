...
<div id="weekschedule">
	<div class="dayschedule">
		<h3 class="days">Senin, xx-xx-xxxx</h3>

		<h3 class="daytitle">Divisi X</h3>
		<p>HMIF vs HOHO</p>
		<p>Jam tanding</p>
		<h3>Divisi X</h3>
		<p>HMIF vs HOHO</p>
	...
	<div class="dayschedule">
		<h3 class="days">Selasa, xx-xx-xxxx</h3>
	...
	<div class="dayschedule">
		<h3 class="days">Rabu, xx-xx-xxxx</h3>
	...
	<div class="dayschedule">
		<h3 class="days">Kamis, xx-xx-xxxx</h3>
	...
	<div class="dayschedule">
		<h3 class="days">Jumat, xx-xx-xxxx</h3>
	...
	<div class="dayschedule">
		<h3 class="days">Sabtu, xx-xx-xxxx</h3>
	...
	<div class="dayschedule">
		<h3 class="days">Minggu, xx-xx-xxxx</h3>
